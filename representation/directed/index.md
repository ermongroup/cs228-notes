...
**Framework for determining d-separation** {% Citation: Pieter Abbeel's YouTube video on d-separation https://www.youtube.com/watch?v=yDs_q6jKHb0&t=1040s%}
...
{% include marginfigure.html id="dp2" url="assets/img/dsep3.png" description="In this example, $$Y$$ and $$Z$$ are not $$d$$-separated given $$X$$." %}{% include marginfigure.html id="dp1" url="assets/img/dsep3.png" description="Here we shade out our evidence node as described in the framework to determine if triples are active or inactive." %}
